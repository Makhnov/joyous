...
class SimpleEventPage(EventBase, Page, metaclass=FormDefender):
    ...
    convocation = models.OneToOneField(
        ...
        help_text=_("If the event is a council, a bureau, a commision, a work group or a mayor's meeting, you can link it to a convocation page. Otherwise, leave this blank."),
        unique=True,
    )
